...
__decorate([
    ...
    __metadata("design:type", Number)
], Conversation.prototype, "idPedido", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'int', name: 'id_publicacion', nullable: true }),
    __metadata("design:type", Number)
], Conversation.prototype, "idPublicacion", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'int', name: 'buyer_id' }),
    __metadata("design:type", Number)
], Conversation.prototype, "buyerId", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'int', name: 'seller_id' }),
    __metadata("design:type", Number)
], Conversation.prototype, "sellerId", void 0);
__decorate([
    (0, typeorm_1.CreateDateColumn)({ name: 'creado_en' }),
    __metadata("design:type", Date)
], Conversation.prototype, "creadoEn", void 0);
__decorate([
    (0, typeorm_1.UpdateDateColumn)({ name: 'actualizado_en' }),
    __metadata("design:type", Date)
], Conversation.prototype, "actualizadoEn", void 0);
